...
<body>
  ...
  %>
 <center><h1>Enter your Details for Requesting Blood</h1></center>
 <form action="indexFormAction.jsp" method="post">
 <center>
 <input type="text" name="name" placeholder="Enter your name" required="required">
 <input type="text" name="mobilenumber" placeholder="Enter your mobile number" required="required">
 <input type="mail" name="email" placeholder="Enter your email" required="required">
 <input type="text" name="bloodgroup" placeholder="Enter your blood group" required="required">
